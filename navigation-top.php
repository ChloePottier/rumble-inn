 ...
 */ ?>
<!-- Menu desktop -->
<div class="container-fluid  bg-white d-none d-lg-block position-relative" id="navbar" itemscope itemtype="https://schema.org/BreadcrumbList">
    <div class="container">
        <nav class="row ">
...
<div class="container-fluid d-block d-lg-none position-fixed" id="nav-burger" itemscope itemtype="https://schema.org/BreadcrumbList">
    <div class="container">
        <div class="row">
            <div class="col">
